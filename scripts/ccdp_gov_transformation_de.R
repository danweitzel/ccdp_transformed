...
## Cleaning up
rm(ccd_other, ccd_parties, ccd_subjects, df_other, df_other_transformed,
   ...
   df_other_transformed_receive, both_government_other, gov_subject_other, gov_other, df_combined)
